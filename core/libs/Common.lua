...
local classIds = {1, 2, 3, 4, 5, 7, 8, 9, 11}
for i = 1, #classIds do
...
local invalidItemTypes = {
	[LE_ITEM_CLASS_ARMOR] = {
		...
		[LE_ITEM_ARMOR_SHIELD] = {"DRUID", "HUNTER", "MAGE", "PRIEST", "ROGUE", "WARLOCK"},
		[LE_ITEM_ARMOR_IDOL] = {"HUNTER", "MAGE", "PALADIN", "PRIEST", "ROGUE", "SHAMAN", "WARRIOR", "WARLOCK"},
		[LE_ITEM_ARMOR_LIBRAM] = {"DRUID", "HUNTER", "MAGE", "PRIEST", "ROGUE", "SHAMAN", "WARRIOR", "WARLOCK"},
		[LE_ITEM_ARMOR_TOTEM] = {"DRUID", "HUNTER", "MAGE", "PALADIN", "PRIEST", "ROGUE", "WARRIOR", "WARLOCK"},
	},
	[LE_ITEM_CLASS_WEAPON] = {
		[LE_ITEM_WEAPON_BOWS] = {"DRUID", "MAGE", "PALADIN", "PRIEST", "SHAMAN", "WARLOCK"},
		[LE_ITEM_WEAPON_CROSSBOW] = {"DRUID", "MAGE", "PALADIN", "PRIEST", "SHAMAN", "WARLOCK"},
		[LE_ITEM_WEAPON_DAGGER] = {"PALADIN"},
		[LE_ITEM_WEAPON_UNARMED] = {"MAGE", "PALADIN", "PRIEST", "WARLOCK"},
		[LE_ITEM_WEAPON_GUNS] = {"DRUID", "MAGE", "PALADIN", "PRIEST", "SHAMAN", "WARLOCK"},
		[LE_ITEM_WEAPON_AXE1H] = {"DRUID", "MAGE", "PRIEST", "ROGUE", "WARLOCK"},
		...
		[LE_ITEM_WEAPON_STAFF] = {"PALADIN", "ROGUE", "WARRIOR"},
		...
		[LE_ITEM_WEAPON_WAND] = {"DRUID", "HUNTER", "PALADIN", "ROGUE", "SHAMAN", "WARRIOR"},
		[LE_ITEM_WEAPON_THROWN] = {"DRUID", "MAGE", "PALADIN", "PRIEST", "SHAMAN", "WARLOCK"},
	},
}
