...
function GUI.CreateBPGPDataImportFrame()
	local f = GUI.CreateCustomFrame("BPGPDataImportFrame", UIParent, "DefaultBackdrop")
  f:Hide()
  ...
  help:SetText(L["To import log records please paste the exported text."].."\n"..
               L["Only missing records will be imported, errors will be reported if found."])
  f.help = help
  ...
  button1:SetScript("OnClick", function (self)
    Logger.Import(private.parsedData)
    f:Hide()
  end)
  f.button1 = button1
...
function private.AsyncParseData()
  ...
  local data, err = Logger.ParseData(importString)
  if err then
    private.frame.editBox:SetText("|cFFFF0000"..L["Warning! Pasted data is invalid!"].."|r".."\n"..
                                  err.."\n"..
                                  L["Received input: %d bytes."]:format(#importString))
  else
    private.parsedData = data
    private.frame.button1:Enable()
    private.frame.editBox:SetText("|cFF00FF00"..L["Pasted data seems to be valid!"].."|r".."\n"..
                                 L["Press 'Import' to continue or 'Cancel' to abort."].."\n"..
                                 L["Received input: %d bytes."]:format(#importString))
  end
